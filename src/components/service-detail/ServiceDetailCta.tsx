      ...
      <div className="container relative z-10 mx-auto gutter-x">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-[#EDE4D6]/85 mb-10 max-w-2xl mx-auto leading-relaxed">
            Contact VIX General Services for reliable {service.name.toLowerCase()} planning and project delivery. Upfront pricing, clear timelines, and dedicated regional craftsmanship.
          </p>
