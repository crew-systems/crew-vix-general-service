    ...
    <section className="section-pad bg-white border-y border-[#00153F]/10">
      <div className="container mx-auto gutter-x">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {SERVICE_AREAS.map((area) => (
            <Link
              ...
              className="group bg-[#F5F6F8] rounded-xl p-6 border border-[#00153F]/10 shadow-crisp hover:shadow-crisp-lg transition-all duration-300 flex flex-col"
            >
              <div className="flex items-center gap-2 text-[#C99A55] mb-3">
                <MapPin className="w-5 h-5" />
                <span className="text-xs font-extrabold uppercase tracking-wider text-[#00153F]">
                  {area.fullName}
                </span>
              </div>

              <h3 className="text-xl font-heading font-extrabold text-[#00153F] mb-2 group-hover:text-[#C99A55] transition-colors">
              ...
              <div className="inline-flex items-center text-xs font-bold text-[#00153F] group-hover:text-[#C99A55] transition-colors pt-2 border-t border-[#00153F]/10">
        ...
        <div className="mt-10 text-center">
          <Link
            to="/service-areas"
            className="inline-flex items-center gap-2 text-sm font-bold text-[#00153F] hover:text-[#C99A55] transition-colors"
          >
