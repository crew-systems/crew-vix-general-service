...
export const ServiceAreaWhyGallery: React.FC<ServiceAreaWhyGalleryProps> = ({
  ...
  return (
    <>
      ...
      <section className="section-pad vix-navy-gradient text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {differentiators.map((item, i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-[#0B2F64]/60 backdrop-blur-md rounded-lg p-6 border border-white/10 hover:border-[#C99A55]/50 transition-all"
                >
                  <div className="w-11 h-11 rounded-md bg-[#C99A55] text-[#00153F] flex items-center justify-center mb-3.5 border border-white/10">
        ...
        <div className="container mx-auto gutter-x">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {area.galleryImages.map((img, index) => (
              <div
                key={index}
                className="relative rounded-lg overflow-hidden shadow-crisp hover:shadow-crisp-lg transition-all duration-500 cursor-pointer group h-72 border border-[#00153F]/10 bg-[#00153F]/5"
              >
                <img
                  src={img}
      ...
      <section className="relative section-pad overflow-hidden vix-navy-gradient">
        ...
        <div className="container relative z-10 mx-auto gutter-x text-center max-w-4xl">
          ...
          <button
            ...
            className="px-10 py-4.5 rounded-lg bg-[#C99A55] text-[#00153F] font-extrabold text-lg sm:text-xl hover:bg-[#D4A55C] transition-all duration-300 shadow-crisp-lg inline-flex items-center gap-3 border border-white/20"
          >
