  ...
  return (
    <>
        ...
        <div className="container mx-auto gutter-x">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {SERVICES.map((service, index) => (
              <div
                key={index}
                className="bg-[#F5F6F8] rounded-lg p-6 border border-[#00153F]/10 shadow-crisp hover:shadow-crisp-lg transition-all duration-300 flex flex-col"
              >
                <div className="w-11 h-11 rounded-md bg-[#C99A55]/10 text-[#C99A55] flex items-center justify-center mb-4">
                  <Wrench className="w-5 h-5" />
                </div>
                <h3 className="text-lg font-heading font-extrabold text-[#00153F] mb-2">
                  <Link
                ...
                <div className="flex items-center justify-between pt-2 border-t border-[#00153F]/10">
                  <Link
                    to={`/services/${service.slug}`}
                    className="inline-flex items-center text-xs font-bold text-[#00153F] hover:text-[#C99A55] transition-colors"
                  >
          ...
          <div className="mt-14 text-center">
            <button
              ...
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg bg-[#00153F] text-[#EDE4D6] hover:bg-[#0B2F64] font-bold text-base transition-all shadow-crisp hover:shadow-crisp-lg"
            >
      ...
      <section className="section-pad bg-[#F5F6F8]">
        <div className="container mx-auto gutter-x">
          <div className="max-w-4xl mx-auto bg-white rounded-lg p-8 sm:p-11 border border-[#00153F]/10 shadow-crisp-lg">
            ...
            <div className="flex items-center gap-4 pt-4 border-t border-border/60">
              ...
              <div>
                <h4 className="font-heading font-extrabold text-[#00153F] text-base flex items-center gap-1">
                  {area.reviewName}
