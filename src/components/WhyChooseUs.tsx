      ...
      <div className="container mx-auto gutter-x">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="absolute -bottom-5 -right-1 sm:right-5 bg-[#00153F] text-[#EDE4D6] p-5 rounded-lg shadow-crisp-lg border border-[#C99A55]/40 max-w-[200px]">
          ...
          <div className="lg:col-span-7">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-md bg-[#00153F]/10 text-[#00153F] font-bold text-xs uppercase tracking-wider mb-4 border border-[#00153F]/20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-8">
              {differentiators.map((diff, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-white p-5 rounded-lg border border-[#00153F]/12 shadow-crisp hover:border-[#C99A55]/50 hover:-translate-y-1 hover:shadow-crisp-lg transition-all duration-300 ease-out"
                  >
                    ...
                    <h3 className="font-heading font-extrabold text-[#00153F] text-sm mb-1.5">
                      {diff.title}
                    </h3>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg bg-[#00153F] text-[#EDE4D6] font-bold text-base hover:bg-[#0B2F64] transition-all shadow-crisp border border-[#C99A55]/25 text-center"
              >
                Get Free Estimate
              </button>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg bg-white text-[#00153F] font-bold text-base border border-[#00153F]/15 hover:bg-[#F5F6F8] transition-all text-center"
              >
